namespace SistemaFerias
{
    partial class frm_rel_produtos
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.DS_relatorios_produtos = new SistemaFerias.DS_relatorios_produtos();
            this.tb_produtoBindingSource = new System.Windows.Forms.BindingSource(this.components);
            this.tb_produtoTableAdapter = new SistemaFerias.DS_relatorios_produtosTableAdapters.tb_produtoTableAdapter();
            ...
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "SistemaFerias.Relatorios.rel_Produtos.rdlc";
